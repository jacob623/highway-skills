...
- Confirm all eight Request Solution Constraints render in canonical order, mandatory violations
  ...
  Required Platform Match is 100, known-system alignment is 100/75/50, and matrix compliance is
  `Fully Compliant` or `Satisfied`.
