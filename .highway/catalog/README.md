...
- `library-index.json` — authoritative, machine-readable listing of every file under
  `.highway/library/`, grouped by library type. Conforms to
  [../../specs/005-rename-content-to-library/contracts/library-catalog.schema.json](../../specs/005-rename-content-to-library/contracts/library-catalog.schema.json).
