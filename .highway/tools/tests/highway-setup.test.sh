...
require_text 'owner workflow'
require_text 'catalogs'
require_text 'identifiers'
require_text 'candidates'
require_text 'relationships'
require_text 'does not directly create'
...
require_text 'Guided Setup'
require_text 'Current Stage'
require_text 'Current Activity'
require_text 'Completed Stages'
require_text 'Remaining Stages'
require_text 'Step 1: Profile'
require_text 'Step 2: Objectives'
require_text 'Step 3: Controls'
require_text 'Step 4: NFRs'
require_text 'terminality decision table'
require_text 'byte-identical'
require_text 'one unresolved question'
require_text 're-read persisted owner readiness'
require_text 'without creating a cancellation marker'
require_text 'automatically advance'
require_text 'forward it to the owning workflow'
require_text 'Highway Setup Complete'
require_text 'terminal success'
require_text 'FR-009A'
require_text 'numeric step mapping'
require_text 'exactly one unresolved owner question at a time'
require_text 'not an independently persisted wizard checkpoint'
require_text 'deterministic'
require_text 'unknown'
require_text 'response-shape failure'
require_text 'never fabricate completion'
require_text 'automatically advances'
require_text 'no numeric `Step` is emitted at completion'
require_text 'informational output'
require_text 'owner output ordering is preserved'
require_text 'classification table'
require_text 'User Exits'
require_text 'Owner Outcomes'
require_text 'writes candidate state'
require_text 'writes relationship state'
require_text 'all governed mutations originate from the owning workflow'
require_text 'enter Guided Setup at the first non-terminal owner'
require_text 'never persists owner collection state'
require_text 'draft responses'
require_text 'wizard checkpoints'
require_text 'welcome or resume greeting'
require_text 'active owner workflow'
require_text 'next unresolved question'
require_text 'Explicit Status Contract'
require_text 'owner-owned content'
require_text 'applicable to the current interaction outcome'
require_text 'does not emit a collection question'
require_text 'Explicit Status Contract is never emitted during routine question collection'
require_text 'During active collection'
require_text 'first incomplete stage'
require_text 'owner contract'
require_text 'workflow routing'
require_text 'forwarding response'
require_text 'repository initialization state'
require_text 'setup is declined'
require_text 'setup is aborted'
require_text 'resume greeting'
require_text 'version: 3.0.0'
