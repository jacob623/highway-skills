...
| FR-010 | satisfied | `.highway/tools/tests/constitution-inventory.test.sh`: all twelve Enforcement-Map-mapped checks were proved to fail per declared class, including this check's own `source-document` self-probe branch |
